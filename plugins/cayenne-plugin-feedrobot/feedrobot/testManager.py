...
def connect_client():
    ...
    try:
        ...
        FeedRobotManager.register('ConditionStatus')
        FeedRobotManager.register('HealthStatus')
...
if __name__ == "__main__":
    ...
    # debug("Sensor body temp:{}".format(manager.FeedRobotHub().get_food_weight()))
    debug("Sensor amb temp:{}".format(manager.FeedRobotHub().get_condition_status()))
