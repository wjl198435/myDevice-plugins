...
# from feedrobot.weightsensors.weight import FoodWeightClass
from feedrobot.manager import connect_client
...
#
#         Arguments:
#         use_emulator: True if the Sense HAT Emulator
#         should be used. This requires the Emulator to be installed and running on the desktop.
#         """
#         self.use_emulator = use_emulator
#         self.sense_hat = None
#         self.digital_value = 0
#         self.analog_value = 0.0
#         self.image_file = os.path.join('/etc/myDevices/plugins/cayenne-plugin-feedrobot/data/image.png')
